 ...
 *
 *    Log
 *    Log everything instead of android.util.Log.
 *
 *    @author: gao_chun
 *    @since:  2010-01-18
 *    @version: 1.0
...
public final class Log {
    ...
    /**
     * Priority constant for the {@link #println(int, String, String)} or {@link #setFilterLevel(int)} method; use Log.d.
     */
    public static final int DEBUG = 3;

    /**
     * Priority constant for the {@link #println(int, String, String)} or {@link #setFilterLevel(int)} method; use Log.i.
     */
    public static final int INFO = 4;

    /**
     * Priority constant for the {@link #println(int, String, String)} or {@link #setFilterLevel(int)} method; use Log.w.
     */
    public static final int WARN = 5;

    /**
     * Priority constant for the {@link #println(int, String, String)} or {@link #setFilterLevel(int)} method; use Log.e.
     */
    ...
    public static int info(Object tag, String msg) {
        return println(INFO, tag.toString(), msg);
    }
