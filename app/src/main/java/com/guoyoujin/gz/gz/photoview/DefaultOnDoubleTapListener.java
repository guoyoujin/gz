package com.guoyoujin.gz.gz.photoview;
 ...
 * <p>&nbsp;</p>
 * To be used via {@link com.guoyoujin.gz.gz.photoview.PhotoViewAttacher#setOnDoubleTapListener(android.view.GestureDetector.OnDoubleTapListener)}
 */
